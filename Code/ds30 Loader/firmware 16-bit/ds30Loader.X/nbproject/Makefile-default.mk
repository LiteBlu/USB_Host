...
MP_LINKER_FILE_OPTION=--script="C:\Program Files (x86)\Microchip\MPLAB ASM30 Suite\Support\PIC24F\gld\p24FJ64GB002.gld"
# ------------------------------------------------------------------------------------
...
${OBJECTDIR}/_ext/1360937237/ds30loader.o: ../src/ds30loader.s  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/1360937237/ds30loader.o.d" $(SILENT) -rsi ${MP_AS_DIR}../  -c ${MP_AS} $(MP_EXTRA_AS_PRE)  ../src/ds30loader.s -o ${OBJECTDIR}/_ext/1360937237/ds30loader.o -omf=elf -p=$(MP_PROCESSOR_OPTION) --defsym=__DEBUG=1 --defsym=__MPLAB_DEBUGGER_PK3=1 -g -I"../src" -MD "${OBJECTDIR}/_ext/1360937237/ds30loader.o.d" 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/ds30Loader.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    C:/Program\ Files\ (x86)/Microchip/MPLAB\ ASM30\ Suite/Support/PIC24F/gld/p24FJ64GB002.gld
